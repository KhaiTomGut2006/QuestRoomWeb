  ...
  apps: [
    {
      ...
      env: {
        ...
        ENTRY_QUEUE_MAX_ACTIVE_LOADERS: process.env.ENTRY_QUEUE_MAX_ACTIVE_LOADERS || "12",
        ENTRY_QUEUE_ADMIT_PER_TICK: process.env.ENTRY_QUEUE_ADMIT_PER_TICK || "3",
        ...
        ENTRY_QUEUE_RETRY_MS: process.env.ENTRY_QUEUE_RETRY_MS || "2000",
        ENTRY_QUEUE_ENFORCE_SOCKET: process.env.ENTRY_QUEUE_ENFORCE_SOCKET || "false",
